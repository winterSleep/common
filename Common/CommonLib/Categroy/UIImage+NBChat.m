...
@implementation UIImage (NBChat)

- (UIImage *)imageByResizingToSize:(CGSize)targetSize
...
- (NSData *)imageByResizingToSize:(CGSize)targetSize
              preserveAspectRatio:(BOOL)preserveAspectRatio
                        trimToFit:(BOOL)trimToFit
                        maxLength:(NSUInteger)maxLength{
    UIImage *image = [self imageByResizingToSize:targetSize preserveAspectRatio:preserveAspectRatio trimToFit:trimToFit];
    return [image compressToMaxFileSize:maxLength];
}

- (NSData *)compressToMaxFileSize:(NSUInteger)maxFileSize {
...
- (UIImage *)imageByRotating:(UIImageOrientation)orientation {
